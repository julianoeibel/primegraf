...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Nome = $GetPost['name'];
    $Email = $GetPost['email'];
    $NomeEmpresa = $GetPost['nomeEmpresa'];
    ...
    $Mailer->Body = "Mensagem enviada através do site por {$Nome} <br>E-mail: {$Email}<br>Nome da Empresa: {$NomeEmpresa}<br> Telefone: {$Phone}<br> Mensagem: {$Mensagem}";
